...
(function (self) {
    ...
    pollVoteBtn.addEventListener('click', function (e) {
        ...
        if (selectedOptionId === '-1') {
            ...
            } else if (pollOptionsArray.find(function (el) {
                return el.textContent === voteOption.option;
            })) {
        ...
        fetch('/polls/user/vote/' + currentId, fetchInit).then(function (res) {
            return res.json();
        }).then(function (json) {
    ...
    deletePollBtn && deletePollBtn.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    shareTwitterBtn && shareTwitterBtn.addEventListener('click', function (e) {
        e.preventDefault();
